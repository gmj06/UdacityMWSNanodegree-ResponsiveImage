...
```
  ...
  * **name**<br />
    ...
    *Version:* 0.0.1 and above
    ...
    If a `name` is specified, then the file will be suffixed with this name. e.g. `my-image-large_1024.jpg`<br />
  ...
  * **suffix**<br />
    ...
    *Version:* 0.0.1 and above
    ...
    Use `suffix` for retina graphic filenames. e.g. `my-image-320x240_1024.jpg`
